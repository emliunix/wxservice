(ns liu.wx.signature-test
  (:require [liu.wx.signature :refer [sign]]
            [clojure.test :refer [deftest is]]))

;; data cited from official weixin sample code for reliability
(def timestamp "1409735669")
(def msg-sign "5d197aaffba7e9b25a30732f161a50dee96bd5fa")
(def token "spamtest")
(def nonce "1320562132")
...
(def encrypted-data "")

(deftest sign-test
  (is (= msg-sign
         (sign token timestamp nonce encrypted-data))))
